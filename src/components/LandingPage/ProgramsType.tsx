                ...
                >
                  <div>
                    <img
                      src={categorie?.image}
                      alt="Book"
                      className="w-full h-64 lg:h-[19rem] rounded-3xl"
                      loading="lazy"
                    />
                  </div>
                  <div
                    className={`${
                      index === 0
                        ...
                        ? "bg-[#FFB6BF]"
                        : "bg-[#FFCC1A]"
                    } mt-4 rounded-3xl text-white px-4 lg:px-5 py-4 text-center cursor-pointer h-56 flex flex-col justify-between items-center`}
                    onClick={() => setIndexCategory(categorie.id)}
                  >
                    <h2 className="text-lg lg:text-xl">{categorie?.name}</h2>
                    ...
                    {categorie.id === 2 ? (
                      <div className="text-[#000000ad]">
                        ...
                        <p className="text-sm font-base">
                          {t(
                            "You can register yourself at any international university."
                          )}
                        </p>
                      </div>
                    ) : (
