...
const PartnerTeam = () => {
  ...
  return (
    <div className="sm:flex bg-[#F7F7F7] max-w-full sm:max-w-5xl flex-col justify-between items-center md:max-w-6xl lg:max-w-[80rem] p-24 rounded-[150px] shadow-lg mx-auto h-[85vh] my-8 mb-20">
